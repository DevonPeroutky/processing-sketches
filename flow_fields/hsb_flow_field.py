"""
A very basic, low opacity FlowField using an angle_grid and particle_manager. It ends up just making everything gray if it goes for a while
"""
...
def setup():
    ...
    [
        particle_manager.build_layer_of_particles(
            ...
            starting_velocity=randint(2, 10)) for _ in range(0, 10)
    ]
