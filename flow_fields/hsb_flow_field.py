...
def create_layer(frameCount, quantity, emotion, line_length):
...
def draw():
    ...
    if frameCount % (24 * 1) == 0:
        ...
        create_layer(frameCount=frameCount, quantity=lines_per_layer, emotion="surprise", line_length=line_length)
